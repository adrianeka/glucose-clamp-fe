...
const navItems: NavItem[] = [
  {
    ...
    icon: (active) => <Users size={20} className={active ? "text-[#0076D2]" : "text-[#707784]"} />,
  },
  {
    label: "Global Configuration",
    href: "/global-configuration",
    icon: (active) => <Settings size={20} className={active ? "text-[#0076D2]" : "text-[#707784]"} />,
  },
  {
    label: "Phase Management",
    href: "/phase-management",
    icon: (active) => <Layers size={20} className={active ? "text-[#0076D2]" : "text-[#707784]"} />,
  },
  {
    label: "Protocol & Sampling",
    href: "/protocol-sampling",
    icon: (active) => <FileText size={20} className={active ? "text-[#0076D2]" : "text-[#707784]"} />,
    hasChevron: true,
  ...
  },
  {
    ...
    icon: (active) => <CalendarDays size={20} className={active ? "text-[#0076D2]" : "text-[#707784]"} />,
  },
  {
