...
export function EditParticipantModal({
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && handleCancel()}>
      <DialogContent
        className="p-0 gap-0 rounded-xl border-0 shadow-xl [&>button]:hidden w-[calc(100%-32px)] max-w-[460px] md:w-[460px] flex flex-col overflow-hidden"
      >
        <button
        ...
        <div className="px-6 md:px-8 pb-6 flex flex-col gap-4 border-t border-[#E2E4E6] pt-5 max-h-[60vh] overflow-y-auto">
