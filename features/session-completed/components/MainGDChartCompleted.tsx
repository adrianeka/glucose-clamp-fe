...
export default function MainGDChartCompleted({
  protocolId,
  sessionData
}: Props) {
  ...
  const yAxisMax = useMemo(() => {
    const maxDataValue = gdData.length ? Math.max(...gdData.map((d: any) => d.glucose)) : 0;
    return Math.max(maxDataValue, extremeMax, targetMax) + 10;
  }, [gdData, extremeMax, targetMax]);
      ...
      <ResponsiveContainer width="100%" height={260}>
        ...
        >
          ...
          <ReferenceLine
            ...
            strokeDasharray="5 5"
            label={{
              value: 'Target Min - ' + targetMin + ' mg/dL',
              position: 'top',
              fill: '#F59E0B',
              fontSize: 10
            }}
          ...
          <ReferenceLine
            ...
            strokeDasharray="5 5"
            label={{
              value: 'Target Max - ' + targetMax + ' mg/dL',
              position: 'top',
              fill: '#F59E0B',
              fontSize: 10
            }}
          ...
          <ReferenceLine
            ...
            strokeDasharray="5 5"
            label={{
              value: 'Extreme Min - ' + extremeMin + ' mg/dL',
              position: 'top',
              fill: '#EF4444',
              fontSize: 10
            }}
          ...
          <ReferenceLine
            ...
            strokeDasharray="5 5"
            label={{
              value: 'Extreme Max - ' + extremeMax + ' mg/dL',
              position: 'top',
              fill: '#EF4444',
              fontSize: 10
            }}
